import { WebGLRenderer, PerspectiveCamera, Scene, Vector2, Vector3, GridHelper, Quaternion, Matrix4, Vector4 } from 'three';
...
const gui = new GUI();
const guis: Map<(composer: EffectComposer) => ShaderPass> = {
    ...
    HyperSphere: function (composer) {
        ...
        const translate: any = rayMarchingPass.uniforms.transform.value.translate;
...
function chooseFromHash(composer: EffectComposer) {
...
// renderer
const canvas = <HTMLCanvasElement>document.querySelector("#ray-marching");
